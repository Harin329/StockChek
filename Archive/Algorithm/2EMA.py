...
symbolList = ['CRWD', 'ADI', 'AMAT', 'ASML', 'AVGO', 'CREE', 'CY', 'ENTG', 'KLAC', 'LRCX',
                ...
                'PYPL']
watchlist = ['TSLA', 'AAPL', 'AMZN', 'MSFT', 'GOOG', 'FB', 'AMD', 'NVDA', 'NIO', 'PLTR', 'SQ']
sybmL = ['PSN']
...
for sym in watchlist:
    ...
    data50, meta_data50 = ti.get_ema(symbol=sym, interval='daily', time_period=50, series_type='close')
    time.sleep(12)
    pprint(data50.tail(1))

    twentyFifty = data20.tail(1).values[0] > data50.tail(1).values[0]

    print(sym + " " + str(twentyFifty))
